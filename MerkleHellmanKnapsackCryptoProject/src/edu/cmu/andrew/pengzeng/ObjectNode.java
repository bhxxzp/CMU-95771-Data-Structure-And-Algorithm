...
public class ObjectNode
{
   ...
   **/ 
    ...
    **/ 
    public static ObjectNode listCopy_rec(ObjectNode source)
    {
    	...
    	// While the source link is not null, copyTail keep going
    	if (source.link != null) {
    		copyTail = listCopy_rec(source.link);
    		copyHead.addNodeAfter(copyTail.data);
   ...
   *   Indicates that there is insufficient memory for the new list.  
   * @precondition
   *   The length of source is not 1 and the list is not circular.
   *   Big theta = n 
   **/
   ...
   *   big theta(N)
   * @param head
   *   the first element of the list. If null, return 0
   * @return
   ...
   **/  
   public static int listLength_rec(ObjectNode head) {
	   ...
	   // Initiate the result. If head is not null, there must be one element.
	   int result = 1;
	   ...
	   if (head == null) {
		   ...
		   result += listLength_rec(head.link);
	   }
	   return result;
   }
   ...
   **/
   ...
   public String toString() {
		...
		if (this != null){
			ObjectNode temp;
			for (temp = this; temp != null; temp = temp.getLink()) {
				result += temp.getData();
			}
		}
		return result;
   ...
   public static void main(String[] args) {
	   ObjectNode clist = new ObjectNode('A', null);
	   ObjectNode temp = clist;
	   for (int i = 1; i < 26; i++) {
		   temp.addNodeAfter((char)((int)('A') + i));
		   temp = temp.link;
	   }
       System.out.println(clist.toString());
       System.out.println("Number of nodes = " + listLength(clist));
       System.out.println("Number of nodes = " + listLength_rec(clist));
       
       ObjectNode k = listCopy(clist);
       System.out.println(k.toString());
       System.out.println("Number of nodes in k = " + listLength(k));
       System.out.println("Number of nodes in k = " + listLength_rec(k));
       
       ObjectNode k2 = listCopy_rec(clist);
